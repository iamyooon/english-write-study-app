...
- **학년별 맞춤 학습**:
  ...
  - **미션 데이터 관리**:
    - 모든 미션은 `missions` 테이블에 저장되어 있음
    - 사용자가 완료한 미션은 자동으로 제외되어 중복 학습 방지
    - 랜덤하게 미션을 선택하여 다양한 학습 경험 제공
...
│   │   └── study/
│   │       ├── generate-mission/         # 키보드 입력 미션 조회 (DB 기반, 학년 1-6)
│   │       ├── generate-drag-drop-mission/  # Drag & Drop 미션 조회 (DB 기반, 학년 1-3)
