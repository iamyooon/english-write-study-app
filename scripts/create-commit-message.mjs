...
console.log('');
console.log('⚠️ 중요: Git 설정이 UTF-8로 되어 있는지 확인하세요:');
console.log('  git config --global i18n.commitencoding utf-8');
console.log('  git config --global i18n.logoutputencoding utf-8');
console.log('');
